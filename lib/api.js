...
function setupJob(request, responseHandler) {
    ...
    Promise.all([
        ...
        return respond(responseHandler, {
            received: true,
            jobId: jobId,
...
function respond(response, obj) {
    const contentType = (typeof obj == 'string') ? 'text/html' : 'application/json';
    response.writeHead(200, {'Content-Type': contentType});
    if (contentType == 'application/json') obj = JSON.stringify(obj);
